...
# hide
APPS="MusicFX AudioFX SoundEnhancement AM3DZireneSound
      ArkamysAudio AudioFx AudioWizard DiracAudioControlService
      daxService OPSoundTuner AudioEffectCenter DolbyAtmos
      MotoDolbyDax3 WavesService"
hide_app
